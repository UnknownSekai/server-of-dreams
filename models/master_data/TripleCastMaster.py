...
class TripleCastMaster(BaseModel):
    model_config = ConfigDict(populate_by_name=True)
    id_: int = Field(default=0, alias="id")
    music_master_id: int = 0
    vocal_version: int = 0
    max_difficulty: MusicDifficulties = MusicDifficulties.None_
    sense_notation_master_id1: int = 0
    sense_notation_master_id2: int = 0
    sense_notation_master_id3: int = 0
    display_start_at: str = ""
    counting_start_at: str = ""
    display_end_at: str = ""
    league_class_group_master_id: int = 0
    triple_cast_season_master_id: int = 0
    vocal_effect_master_id: int = 0
    expression_effect_master_id: int = 0
    concentration_effect_master_id: int = 0
